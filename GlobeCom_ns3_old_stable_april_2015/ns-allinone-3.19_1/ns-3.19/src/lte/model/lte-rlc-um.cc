  ...
  if ( m_txBuffer.size () == 0 )
    {
     ...
     // //std::cout<<"No data pending"<<std::endl;
      return;
    }
  ////std::cout<<"txBufferSize      = " << m_txBufferSize<<std::endl;
  ...
  while ( firstSegment && (firstSegment->GetSize () > 0) && (nextSegmentSize > 0) )
    {
      ...
      NS_LOG_LOGIC ("    nextSegmentSize   = " << nextSegmentSize);
      	  	//std::cout<<"    firstSegment size = " << firstSegment->GetSize ()<<std::endl;
            //std::cout<<"    nextSegmentSize   = " << nextSegmentSize<<std::endl;
