...
{
  NS_LOG_FUNCTION (this);
//std::cout<< "Receiver Window : "<< m_rWnd.Get ()<<" Congestion Window"<< m_cWnd.Get ()<<std::endl;
...
TcpNewReno::NewAck (const SequenceNumber32& seq)
{
 ...
 //std::cout<<"TcpNewReno receieved ACK for seq " << seq << " cwnd " << m_cWnd <<" ssthresh " << m_ssThresh<<std::endl;
