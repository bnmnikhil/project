...
Ptr<LiIonEnergySource> LiIonSourcePtr = DynamicCast<LiIonEnergySource> (source);
  ns3::LteHelper::ntolimap[node]=LiIonSourcePtr;
  ns3::LteHelper::litonmap[LiIonSourcePtr]=node;
  source->SetNode (node);
  return source;
}
